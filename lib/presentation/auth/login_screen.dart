      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
              ...
              style: TextStyle(fontSize: 13, color: AppTheme.textDim, height: 1.65)),
...
class _FormPanel extends StatelessWidget {
  ...
  final bool obscure;
  final VoidCallback onToggleObscure, onLogin, onRegister, onForgotPassword;
  ...
  const _FormPanel({
    ...
    required this.onRegister, required this.onForgotPassword,
    required this.vm,
  });
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // Password row with "Forgot password?" on the right
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
